...
# 1    0.000    0.000    0.000    0.000 les_4_task_1.py:15(n_sum_while)
# cProfile.run('n_sum_while(100)')
# 1    0.000    0.000    0.000    0.000 les_4_task_1.py:15(n_sum_while)
# cProfile.run('n_sum_while(1000)')
# 1    0.000    0.000    0.000    0.000 les_4_task_1.py:15(n_sum_while)
# cProfile.run('n_sum_while(10000)')
# 1    0.001    0.001    0.001    0.001 les_4_task_1.py:15(n_sum_while)
# cProfile.run('n_sum_while(100000)')
# 1    0.010    0.010    0.010    0.010 les_4_task_1.py:15(n_sum_while)
# cProfile.run('n_sum_while(1000000)')
# 1    0.101    0.101    0.101    0.101 les_4_task_1.py:15(n_sum_while)
...
# 10/1    0.000    0.000    0.000    0.000 les_4_task_1.py:27(n_sum_rec)
# cProfile.run('n_sum_rec(100)')
# 100/1    0.000    0.000    0.000    0.000 les_4_task_1.py:27(n_sum_rec)
# cProfile.run('n_sum_rec(500)')
# 500/1    0.000    0.000    0.000    0.000 les_4_task_1.py:27(n_sum_rec)
# cProfile.run('n_sum_rec(991)')
# 991/1    0.001    0.000    0.001    0.001 les_4_task_1.py:39(n_sum_rec)
...
# 1    0.000    0.000    0.000    0.000 les_4_task_1.py:35(n_sum_gp)
